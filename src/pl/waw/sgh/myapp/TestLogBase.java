...
public class TestLogBase {
    public static void main(String[] args) {
        ...
        Beverage bev1 = logBase.createBeverage(1, u1, 12, 200, 95, "120s", "Kenya", 8, 15, 1.3, 0 );
        Beverage bev2 = logBase.createBeverage(1, u1, 12, 200, 97, "120s", "Kenya", 9, 14, 1.4, 0 );
        Beverage bev3 = logBase.createBeverage(3, u2, 6, 400, 70, "60s", "Green", 10, 0, 0, 1 );
        Beverage bev4 = logBase.createBeverage(3, u2, 6, 600, 70, "180s", "Green", 7, 0, 0, 2 );
